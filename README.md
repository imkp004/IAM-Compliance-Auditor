...
<!-- kirtanpatel@Kirtans-MBP ~/IAM-Complience-Auditer/lambda/summarizer % aws lambda invoke --function-name iam-compliance-auditor-audit-lambda response.json -->


<!-- python3 -c "
from handler import lambda_handler
result = lambda_handler({
    'bucket': 'iam-compliance-auditor-267673636159',
    'key': 'reports/2026-08-03T23-19-48.649628+00-00.json'
}, None)
print(result['finding_count'], 'findings')
print('Saved to:', result['summary_s3_key'])
" -->